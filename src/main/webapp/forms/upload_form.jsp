...
<html>
    ...
    <body style="padding: 20px">
        <table>
            <td valign="top">
                <form method="post" class="pure-form" action="/JavaWeb0829-school/servlet/upload" enctype="multipart/form-data" target="myiframe">
                    <fieldset>
            ...
            <td valign="top">
                <iframe frameborder="0" name="myiframe_imagelist"  width="600" height="1000" src="/JavaWeb0829-school/servlet/imagelist"></iframe>
            </td>
        </table>
