    ...
    <body style="padding: 20px">
        <table  class="pure-table pure-table-bordered">
            ...
            <tbody>
                <tr>
                    <td valign="top">
                        <form method="post" class="pure-form" action="/JavaWeb0829-school/servlet/enctype" enctype="application/x-www-form-urlencoded" target="myiframe">
                            <fieldset>
                        ...
                        <p />
                        <form method="post" class="pure-form" action="/JavaWeb0829-school/servlet/enctype" enctype="multipart/form-data" target="myiframe">
                            <fieldset>
                        ...
                        <p />
                        <form method="post" class="pure-form" action="/JavaWeb0829-school/servlet/enctype" enctype="text/plain" target="myiframe">
                            <fieldset>
