...
<html>
    <head>
        ...
        <script>
            function logout() {
                if (confirm('是否要登出 ?')) {
                    window.location.href = '/JavaWeb0829-school/fastfood/logout';
                }
            }
            
            function orderSubmit() {
                if (confirm('是否要結帳 ?')) {
                    window.location.href = '/JavaWeb0829-school/fastfood/submit';
                }
            }
            function itemDelete(no) {
                if (confirm('是否要刪除 no = ' + no + ' 的資料 ?')) {
                    ...
                    xhttp.open("DELETE", "/JavaWeb0829-school/fastfood/order", true);
                    xhttp.send("no="+no);
                }
            }
        </script>
    ...
    <body style="padding: 20px">
        ...
        <form class="pure-form" method="post" action="/JavaWeb0829-school/fastfood/order">
            <fieldset>
                <legend>點餐單</legend>
                主餐: 
                ...
                <a href="/JavaWeb0829-school/fastfood/order">重新整理</a>
            </fieldset>
        </form>
                ...
                <table class="pure-table pure-table-bordered">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="food" items="${sessionScope.shoppingCar}">
                            <tr>
                                <th>${food.no}</th>
                                <th><img src="/JavaWeb0829-school/images/fastfood/${food.name}.png" width="50" valign="middle" align="left">${food.name}</th>
                                <th>${food.price}</th>
